...
export default async function SavedPage() {
  ...
  return <ApprovedStudentShell name={state.name} email={user.email ?? ""} avatarUrl={avatarUrl} stateKind={state.kind} unreadCount={notifications.count ?? 0} active="saved">
    ...
    <section className="approved-saved-layout" data-node-id="17040:13505"><h1>Your Saved Picks</h1><SavedList programs={(programs.data ?? []) as unknown as SavedProgram[]} courses={(courses.data ?? []) as unknown as SavedCourse[]} /></section>
