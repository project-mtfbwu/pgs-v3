...
export default async function PremiumDashboardPage() {
  ...
  return <DeveloperStudentShell name={name} email={user.email ?? ""} avatarUrl={avatarUrl} stateKind={state.kind} unreadCount={state.unreadCount} active="premium" preview={state.preview} contentClassName="developer-premium-dashboard">
