...
export type StudentShellNavKey = "feed" | "premium" | "cv" | "rotation" | "countries" | "profile" | "saved" | "progress" | "documents" | "resources";
...
export const studentSidebarLinks: ReadonlyArray<{ href: string; label: string; key: StudentShellNavKey }> = [
  ...
  { href: "/purpleboard", label: "#purpleBoard", key: "feed" },
...
export function premiumShellDestination(state: StudentShellState): string {
  return state === "authenticated_premium" ? "/dashboard" : "/purplepremiumhome";
}
