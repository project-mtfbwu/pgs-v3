...
select results_eq($$select count(*)::bigint from public.audit_events where actor_user_id='89000000-0000-4000-8000-000000000009' and event_type='premium.granted' and metadata ?& array['plan_code','duration_months','new_status']$$,array[5::bigint],'canonical grant audit retains minimal plan and status evidence');
set local request.jwt.claims='{"sub":"81000000-0000-4000-8000-000000000001","role":"authenticated"}';
